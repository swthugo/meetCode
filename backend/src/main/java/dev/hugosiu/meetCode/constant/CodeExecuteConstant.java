...
public class CodeExecuteConstant {
  public static final String ROOT_LOCATION = "./proj-meetcode-backend";
  public static final String SERVICE_ACCOUNT = ROOT_LOCATION + "/src/main/resources/service-account.json";
